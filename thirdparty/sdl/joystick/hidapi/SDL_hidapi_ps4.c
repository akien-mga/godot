...
{
    static const float TOUCHPAD_SCALEX = 5.20833333e-3; // 1.0f / 1920
    static const float TOUCHPAD_SCALEY = 1.08695652e-3; // 1.0f / 920 // This is noted as being 944 resolution, but 920 feels better
    Sint16 axis;
    bool touchpad_down;
